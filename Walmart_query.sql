...
alter table sales  add column time_of_day varchar(20); 
  ...
  select date,
    ...
    select product_line, count(*) as product_line_total
    from sales
...
select product_line, avg(VAT) as largest_vat from sales
    group by product_line
...
SET product_category = (
 ...
 select product_line, round(avg(rating),2) as average from sales
 group by product_line
